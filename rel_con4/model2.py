...
class WhackModel(nn.Module):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.tanh = nn.Tanh()
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=20, kernel_size=4, stride=1, padding=2)
        self.conv2 = nn.Conv2d(in_channels=20, out_channels=64, kernel_size=2, stride=1, padding=2)
